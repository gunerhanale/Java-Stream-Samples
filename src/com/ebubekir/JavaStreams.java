...
public class JavaStreams {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String[] staffs = {"Al", "Ankit", "Brent", "Sarika", "amanda", "Hans", "Shivika", "Sarah"};
        List<String> people = Arrays.asList(staffs);
        people
                .stream()
        ...
        bands
                ...
                .forEach(System.out::println);
        bands.close();   //to prevent memory leak make sure to close connection
        System.out.println();
